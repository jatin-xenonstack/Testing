...
(async function validInputTest() {
  ...
  try {
    ...
    await driver.findElement(By.xpath("//input[@id='Firstname']")).sendKeys('Jatin');
    await driver.findElement(By.xpath("//input[@id='Lastname']")).sendKeys('Kethuniya');
    await driver.findElement(By.xpath("//input[@id='emailid']")).sendKeys('jatinkethuniya@gmail.com');
    let contactNumber = await driver.findElement(By.xpath("//input[@id='contactnumber']"));
    await contactNumber.click();
    await contactNumber.sendKeys('9691405502');
